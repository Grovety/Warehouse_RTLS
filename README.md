...
Industrial warehouse RTLS HMI demonstration firmware for **Elecrow CrowPanel Advanced ESP32-P4 panels with 1024 × 600 touch displays**.

This package provides a ready-to-use Windows flashing tool for hardware revision **V1.2**.

## Download

[Download the ready-to-use Windows package](./CrowPanelv1.2_Warehouse_v1.1.zip)

## Flashing

1. Download and fully extract `CrowPanelv1.2_Warehouse_v1.1.zip`.
